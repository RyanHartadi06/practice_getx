...
class NetworkService {
  ...
  static String getImageUrl(String imageUrl) {
    return Uri.http(
            ApiEndpoint.baseUrl, '${ApiEndpoint.assetsPrefix}/$imageUrl')
        .toString();
  }

  static Future<dynamic> get(String url, Map<String, String>? queryParameters,
  ...
  static Future<dynamic> post(String url, Map<String, String> data,
      {bool withToken = false}) async {
